...
double Davies(double c1, double* lb1, int r1, int *n1, double *nc1, double sigma, int lim1, double acc)
...

{
      ...
      if(nc1 == NULL){
         nc = new double[r1];
         for(j = 0; j < r1; j++) nc[j] = 0;
      }else
         nc=nc1;
      if(n1 == NULL){
         n = new int[r1];
         for(j = 0; j < r1; j++) n[j] = 1;
      }else
         n = n1;
