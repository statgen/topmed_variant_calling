...
class Matrix
   ...
   void ProductPhi(const Matrix & left, const Matrix & right);
   void sProduct(const Matrix & left, const Matrix & right);
   void sProductPhi(const Matrix & left, const Matrix & right);
   ...
   void CholeskyInvert(Matrix & M);
   void Block2Invert(Matrix & M);
   void Block2Invert(Matrix & M, int extra);
   void BlockInvert(Matrix & M, int blockCount, int extra);
